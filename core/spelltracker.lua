...
function addWatcher(buffName, lr, ud, iconPath, parentSpellIcon, parentSpellName, skipBuff, isShardDependant)
    ...
    local watcher = CreateFrame("Frame", string.format("Frame_%s", buffName), MWarlockMainFrame, "BackdropTemplate")
          watcher:SetSize(100, 32)
          watcher:SetPoint("RIGHT", MWarlockMainFrame, "BOTTOM", lr+10, ud+70)
    ...
    -- frame movement
    -- TO DO, set this script so I can move these where ever and then reparent in situ to the main MWarlockMainFrame
